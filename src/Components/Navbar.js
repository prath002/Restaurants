...
const Navbar = ()=>{
  ...
  <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    ...
    <a href="#responsive-header" class="block mt-4 md:inline-block md:mt-0 text-gray-400 hover:text-gray-900 mr-4">
        Home
      </a>
      <a href="#responsive-header" class="block mt-4 lg:inline-block lg:mt-0 text-gray-400 hover:text-gray-900 mr-4">
        Contact Us
      </a>
      <a href="#responsive-header" class="block mt-4 lg:inline-block lg:mt-0 text-gray-400 hover:text-gray-900 mr-4">
        Scan QR
